...
uiclass, baseclass = pg.Qt.loadUiType(os.path.dirname(path2thisFile) + "/Extract_mosaic_ui_01.ui")
...
class MainWindow(uiclass, baseclass):
    ...
    def sauvegarder_tableaux(self,tableaux):
        ...
        dossier = filedialog.askdirectory(title="Choisissez un dossier pour sauvegarder les tableaux 3D")
