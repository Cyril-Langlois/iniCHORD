...
from inichord import Fct_profil_modification_02 as fct
from inichord import stackModifierGUI_pg_v7_TSG as sm
from inichord import Alignement_GUI_pg_12_TSG as align
from inichord import remFFT_pg_v2_TSG as RemFFT
from inichord import remOutliersGUI_pg_v3_TSG as rO
from inichord import NLMD_GUI_pg_v2_TSG as nl
from inichord import BM3D_GUI_pg_v2_TSG as bm
from inichord import VSNR_GUI_pg_v2_TSG as vs
from inichord import Denoise_GUI_pg_03_TSG as autoden
from inichord import KAD_function_02 as KADfunc
from inichord import Contour_map_pg_01_TSG as Contour
from inichord import Denoise_2Dmap_01 as Denmap
from inichord import GrainTreatment_08_GUI_TSG as GB
from inichord import Restored_01_GUI_TSG as Restored
from inichord import Extract_mosaic_acquisition_02 as Extract_mosaic
from inichord import Batch_processing_02 as Batch
from inichord import TwoD_Stitching_04_GUI as Img_Stitch
from inichord import ThreeD_Stitching_02_GUI as Series_Stitch
from inichord import Indexation_04_GUI_TSG as Indexation_TSG

path2thisFile = abspath(getsourcefile(lambda:0))
uiclass, baseclass = pg.Qt.loadUiType(os.path.dirname(path2thisFile) + "/Traitement_stack_v12.ui")
